...
(0, _jquery.default)(document).ready(function () {
  (0, _jquery.default)(".glazing_slider").slick({
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
    responsive: [{
  ...
  (0, _jquery.default)(".decoration_slider").slick({
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [{
...
var currentOpenPopup = exports.currentOpenPopup = null;
var Popup = /*#__PURE__*/function () {
  ...
  _createClass(Popup, [{
    ...
    key: "sendDataForm",
    value: function sendDataForm() {}
  }]);
  return Popup;
}();
var popupEngineer = new Popup(".popup_engineer", ".popup_engineer_btn", ".popup_close");
var popupCall = new Popup(".popup", ".phone_link", ".popup_close");
var popupCalc = new Popup(".popup_calc", ".popup_calc_btn", ".popup_calc_close ", ".popup_calc_button");
var popupCalcProfile = new Popup(".popup_calc_profile", ".popup_calc_button", ".popup_calc_profile_close", ".popup_calc_profile_button");
var popupCalcEnd = new Popup(".popup_calc_end", ".popup_calc_profile_button", ".popup_calc_end_close");
var popupsContainer = exports.popupsContainer = [popupEngineer, popupCall, popupCalc, popupCalcProfile, popupCalcEnd];
function findPopupOnOpenBtn(btn) {
  var openedPopup = popupsContainer.find(function (popup) {
    return popup.popupShowBtns.includes(btn);
  });
  if (openedPopup) {
